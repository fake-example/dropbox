                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className='flex items-center justify-between'>
                        <div className="!mt-1 text-white">
                            <Link className="group mx-auto flex justify-center items-center py-2 px-7 rounded border-transparent text-sm font-medium text-white bg-green-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" to={"/signin"}>Sign In</Link>
                        </div>
                        <div className="!mt-1">
                            <Link className="group mx-auto flex justify-center items-center py-2 px-7 rounded border-transparent text-sm font-medium text-white bg-green-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" to={"/signup"}>Sign Up</Link>
                        </div>
                    </div>
